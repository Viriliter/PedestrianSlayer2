...
namespace comm{
    ...
    public:
                ...
                try
                {
                    while(driver.isAvailable()){
                        ...
                        if (pair.second.MsgSize>0){
                            message::SerialMessageTypes decoded_message_type;
                            UINT8 messageID = message::decodeMessage(pair.second, decoded_message_type);
        ...
        void writeOutgoing(std::vector<UINT8> &tx_msg){
